...
exports.UtilityApi = exports.UtilityApiFactory = exports.UtilityApiFp = exports.UtilityApiAxiosParamCreator = void 0;
 ...
 * @export
 */
var UtilityApiAxiosParamCreator = function (configuration) {
    var _this = this;
    return {
        /**
         *
 ...
 * @export
 */
var UtilityApiFp = function (configuration) {
    return {
        /**
         *
         * @summary Update or create user data
 ...
 * @export
 */
var UtilityApiFactory = function (configuration, basePath, axios) {
    return {
        /**
         *
         * @summary Update or create user data
 ...
 * @extends {BaseAPI}
 */
var UtilityApi = /** @class */ (function (_super) {
    __extends(UtilityApi, _super);
    function UtilityApi() {

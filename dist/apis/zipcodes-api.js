...
var ZipcodesApiAxiosParamCreator = function (configuration) {
    ...
    return {
         ...
         */
        zipcodesControllerGetZipcode: function (zipcode, options) {
                    ...
                    switch (_b.label) {
                        case 0:
                            ...
                            if (zipcode === null || zipcode === undefined) {
                                throw new base_1.RequiredError('zipcode', 'Required parameter zipcode was null or undefined when calling zipcodesControllerGetZipcode.');
                            }
                            localVarPath = "/api/zipcodes/{zipcode}"
                                .replace("{".concat("zipcode", "}"), encodeURIComponent(String(zipcode)));
        ...
        zipcodesControllerGetZipcode: function (zipcode, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, exports.ZipcodesApiAxiosParamCreator)(configuration).zipcodesControllerGetZipcode(zipcode, options)];
                        case 1:
...
var ZipcodesApiFactory = function (configuration, basePath, axios) {
    return {
        ...
        zipcodesControllerGetZipcode: function (zipcode, options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, (0, exports.ZipcodesApiFp)(configuration).zipcodesControllerGetZipcode(zipcode, options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
    };
...
var ZipcodesApi = /** @class */ (function (_super) {
     ...
     */
    ZipcodesApi.prototype.zipcodesControllerGetZipcode = function (zipcode, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, exports.ZipcodesApiFp)(this.configuration).zipcodesControllerGetZipcode(zipcode, options).then(function (request) { return request(_this.axios, _this.basePath); })];
            });
        });
    };
    return ZipcodesApi;

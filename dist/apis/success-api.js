...
exports.SuccessApi = exports.SuccessApiFactory = exports.SuccessApiFp = exports.SuccessApiAxiosParamCreator = void 0;
 ...
 * @export
 */
var SuccessApiAxiosParamCreator = function (configuration) {
    var _this = this;
    return {
        /**
         *
...
exports.SuccessApiAxiosParamCreator = SuccessApiAxiosParamCreator;
/**
 * SuccessApi - functional programming interface
 * @export
 */
var SuccessApiFp = function (configuration) {
    return {
        /**
         *
         * @summary Update or create success points for a user
...
exports.SuccessApiFp = SuccessApiFp;
/**
 * SuccessApi - factory interface
 * @export
 */
var SuccessApiFactory = function (configuration, basePath, axios) {
    return {
        /**
         *
         * @summary Update or create success points for a user
...
exports.SuccessApiFactory = SuccessApiFactory;
/**
 ...
 * @extends {BaseAPI}
 */
var SuccessApi = /** @class */ (function (_super) {
    __extends(SuccessApi, _super);
    function SuccessApi() {
